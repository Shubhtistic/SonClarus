...
class User(SQLModel, table=True):
    ...
    storage_limit: int = Field(default=104857600)  # 100 MB
...
class Job(SQLModel, table=True):
    ...
    is_denoise: bool = Field(default=True)
    is_separation: bool = Field(default=True)
    is_transcription: bool = Field(default=True)
