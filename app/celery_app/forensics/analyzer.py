...
def generate_waveform_image(file_path: str, output_path: str):
    ...
    # close() -> this is imp matpltlib keep the graph in memory so we need to close or server will crash after multiple uploads
...
def generate_spectrogram_image(file_path: str, output_path: str):
    ...
    # reason ->  e need to un-mix the sound to see the frequencies
